    ...
    if (testimonialCarousel) {
        ...
        if (testimonialCards.length > 0) {
            ...
            const createDots = () => {
                ...
                testimonialCards.forEach((_, index) => {
                    ...
                    dot.addEventListener('click', () => {
                        goToSlide(index);
                        stopCarousel(); // Stop autoplay when user interacts
                        startCarousel(); // and restart it
                    });
            ...
            const goToSlide = (index) => {
                // Recalculate cardWidth in case of responsive changes
            ...
            // Recalculate width and reset position on window resize
            const handleResize = () => {
                goToSlide(currentIndex);
            };
